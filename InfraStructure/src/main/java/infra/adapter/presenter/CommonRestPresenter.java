package infra.adapter.presenter;
...
@Slf4j
public class CommonRestPresenter implements ErrorHandlingPresenterOutputPort {
    ...
    public void presentError(Exception e) {
        ...
        try {
            ...
            // TODO need to have specific exception handling for bad request, consider ExceptionAdivce
