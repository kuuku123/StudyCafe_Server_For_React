...
public class PackageDependencyTests {
    ...
    @ArchTest
    ArchRule modulesPackageRule = classes().that().resideInAPackage("com.StudyCafe_R.StudyCafe_R.modules..")
            .should().onlyBeAccessed().byClassesThat()
            .resideInAnyPackage("com.StudyCafe_R.StudyCafe_R.modules..");
    ...
    @ArchTest
    ArchRule cycleCheck = slices().matching("com.StudyCafe_R.StudyCafe_R.modules.(*)..")
