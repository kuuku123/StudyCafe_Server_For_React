...
public class QEnrollment extends EntityPathBase<Enrollment> {
    ...
    private static final long serialVersionUID = -1006126799L;
    ...
    public final com.StudyCafe_R.modules.account.domain.QAccount account;
    ...
    public QEnrollment(Class<? extends Enrollment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.account = inits.isInitialized("account") ? new com.StudyCafe_R.modules.account.domain.QAccount(forProperty("account")) : null;
